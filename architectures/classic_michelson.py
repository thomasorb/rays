...
class ClassicMichelson:
    ...
    def scan_mirror(
        ...
        Parameters
        ----------
        mirror_positions : array-like
            Physical displacement of the moving mirror.
